...
namespace CompanyMediaTests.CompanyMediaPageTests
{
    internal class LogInPageTests
    {
        ...
        public void LogIn()
        {
            ...
            WaitUntil.ShouldLocate(driver, "http://192.168.0.110:8080/cm5div6/BusinessUniverse.html");
            WaitUntil.WaitElement(driver, MainPageLocators._userButton);
            IWebElement userButton = driver.FindElement(MainPageLocators._userButton, true);
            userButton.Click();
            IWebElement login = driver.FindElement(MainPageLocators._loginInformation, true);
            IWebElement name = driver.FindElement(MainPageLocators._nameInformation, true);
            IWebElement surname = driver.FindElement(MainPageLocators._surnameInformation, true);
            IWebElement email = driver.FindElement(MainPageLocators._emailInformation, true);
