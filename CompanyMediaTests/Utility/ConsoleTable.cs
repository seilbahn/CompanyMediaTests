...
namespace CompanyMediaTests.Utility
{
    internal class ConsoleTable
    {
        ...
        public void Write(Format format = Utility.Format.Default)
        {
            switch (format)
            {
                case Utility.Format.Default:
                    Options.OutputTo.WriteLine(ToString());
                    break;
                case Utility.Format.MarkDown:
                    Options.OutputTo.WriteLine(ToMarkDownString());
                    break;
                case Utility.Format.Alternative:
                    Options.OutputTo.WriteLine(ToStringAlternative());
                    break;
                case Utility.Format.Minimal:
